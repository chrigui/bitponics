...
function(angular, domReady, moment, feBeUtils){
    ...
    drawPhaseGraphs : function(){
        var phases = bpn.pageData.currentGrowPlanInstance.phases,
    ...
    drawControlGraphs : function(){
        var controls = bpn.pageData.currentGrowPlanInstance.controls,
            $container = $('#controls'),
            outerMargin = 0,
    ...
    initEventHandlers : function(){
        $('#controls').on('click', '.control', function(e){
            ...
            var $this = $(this),
                ...
                controlData = bpn.pageData.currentGrowPlanInstance.controls[controlKey];
                    ...
                    function(data){
                        ...
                        $content.on('click', '.action-trigger-link', function(e){
                            var $this = $(this),
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/api/grow-plan-instances/' + bpn.pageData.currentGrowPlanInstance.id + '/action_override_logs',
